...
public class SpecialDis {
    ...
    @Test(priority = 5 , testName = "TC_04",description = "Special discount selection")
    public void addSpecialDiscount(){
        WebElement pressSP = pos.findElementByClassName("ComboBox");
        pressSP.sendKeys(Keys.F4);

        //selecting special discount from dropdown
        WebElement downArrow = pos.findElementByName("None");
...
//
//
    @Test(priority = 6,testName = "TC_05",description = "Focus on cash field")
    public void cash(){
...
//        pressEnter.sendKeys(Keys.ENTER);
    ...
    @Test(priority = 7,testName = "TC_06",description = "Sales, invoice creation and back to new sale screen")
    public void sale(){
